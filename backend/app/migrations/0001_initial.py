    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("pincode", models.CharField(max_length=8, verbose_name="Pin code")),
                ("mobile", models.CharField(max_length=15, verbose_name="Mobile no")),
                (
                    "fax",
                    models.CharField(
                        blank=True, max_length=15, null=True, verbose_name="Fax no"
                    ),
                ),
                (
                    "phone",
                    models.CharField(
                        blank=True, max_length=15, null=True, verbose_name="Phone no"
                    ),
                ),
                (
                    "groups",
